<template>
    <div class="admin-live-view">
      ...
      <div class="card-row">
        <div v-for="(url, index) in videoUrls.slice().reverse()" :key="index" class="card-item" @click="openModal(videoUrls.length - 1 - index)">
        ...
        <div class="modal-content" @click.stop>
          ...
          <div class="upload-section">
            <label class="upload-label">
              ...
              <span class="modal-upload-text">{{ selectedVideo ? 'Video Selected' : 'Drop Files here' }}</span>
              <p>Or</p>
  ...
  export default {
    data() {
      return {
        ...
        selectedVideo: null, // New property to store the selected video
      };
    },
    methods: {
      openModal(index) {
      ...
      eventNumber() {
        return this.videoUrls.length + 1;
      },
      addVideoUrl() {
      ...
      addEmptyCard() {
        ...
        this.videoUrls.unshi(newEmptyCardItem);
      },
      saveVideo() {
