<template>
  <section class=" py-4 sm:px-3 bg-white">
    <div
        ...
        <div v-for="instructor in instructorsDummy" :key="instructor.id" class="card-instructor border-round-md">
          ...
          <div class="p-2 flex flex-column justify-content-between gap-1">
            <div class="flex justify-content-between gap-2">
              <span class="text-xl font-bold">{{ instructor.name}}</span>
              <div class="flex gap-3 align-items-center">
                <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12.0267 0.225946C11.8903 0.0812753 11.7053 0 11.5125 0C11.3196 0 11.1346 0.0812753 10.9982 0.225946L2.08437 9.68097C1.993 9.77789 1.92762 9.89888 1.89496 10.0315L0.925267 13.9693C0.860016 14.2343 0.932102 14.5161 1.11467 14.7097C1.29724 14.9034 1.56292 14.9799 1.81273 14.9107L5.52514 13.8821C5.65017 13.8474 5.76423 13.7781 5.8556 13.6812L14.7694 4.22615C15.0535 3.92489 15.0535 3.43645 14.7694 3.13519L12.0267 0.225946ZM3.25242 10.6239L11.5125 1.86239L13.2267 3.68067L4.96662 12.4422L2.64636 13.0851L3.25242 10.6239Z" fill="black"/>
                  <path d="M1.22727 16.4571C0.825611 16.4571 0.5 16.8025 0.5 17.2286C0.5 17.6546 0.825611 18 1.22727 18H15.7727C16.1744 18 16.5 17.6546 16.5 17.2286C16.5 16.8025 16.1744 16.4571 15.7727 16.4571H1.22727Z" fill="black"/>
                </svg>
                
                <svg width="15" height="18" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5.56452 0C5.16366 0 4.83871 0.298571 4.83871 0.666877V1.33375H0.725806C0.324955 1.33375 0 1.63232 0 2.00063C0 2.36894 0.324955 2.66751 0.725806 2.66751H14.2742C14.675 2.66751 15 2.36894 15 2.00063C15 1.63232 14.675 1.33375 14.2742 1.33375H10.1613V0.666877C10.1613 0.298571 9.83634 0 9.43548 0H5.56452Z" fill="black"/>
                  <path d="M8.52645 11.3369L9.94871 12.6437C10.2322 12.9041 10.2322 13.3264 9.94871 13.5868C9.66526 13.8472 9.20571 13.8472 8.92226 13.5868L7.50001 12.28L6.07775 13.5868C5.7943 13.8472 5.33475 13.8472 5.0513 13.5868C4.76786 13.3264 4.76786 12.9041 5.0513 12.6437L6.47356 11.3369L5.05129 10.0301C4.76785 9.76968 4.76785 9.34744 5.05129 9.08701C5.33474 8.82658 5.79429 8.82658 6.07774 9.08701L7.50001 10.3938L8.92227 9.08702C9.20572 8.82658 9.66527 8.82658 9.94872 9.08702C10.2322 9.34745 10.2322 9.76969 9.94872 10.0301L8.52645 11.3369Z" fill="black"/>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M1.68525 5.03908C1.72609 4.70135 2.03678 4.44585 2.40662 4.44585H12.5934C12.9632 4.44585 13.2739 4.70135 13.3147 5.03908L13.5084 6.64078C13.8595 9.5442 13.8595 12.4744 13.5084 15.3779L13.4894 15.5355C13.35 16.688 12.3779 17.607 11.128 17.7678C8.72106 18.0774 6.27893 18.0774 3.87201 17.7678C2.62214 17.607 1.65 16.688 1.51062 15.5355L1.49156 15.3779C1.14045 12.4744 1.14045 9.5442 1.49156 6.64078L1.68525 5.03908ZM3.05624 5.7796L2.93429 6.78807C2.59502 9.5936 2.59502 12.425 2.93429 15.2306L2.95336 15.3882C3.01946 15.9348 3.48051 16.3707 4.07327 16.4469C6.34667 16.7394 8.65332 16.7394 10.9267 16.4469C11.5195 16.3707 11.9805 15.9348 12.0466 15.3882L12.0657 15.2306C12.405 12.425 12.405 9.5936 12.0657 6.78807L11.9437 5.7796H3.05624Z" fill="black"/>
                </svg>

              </div>
            </div>
            
            <span class="text-sm text-gray-500 font-bold">Branch - {{ instructor.branch }}</span>
            <span class="text-sm text-gray-500 font-bold">Enrolled students - {{ instructor.enrolled }}</span>

            <Button label="PROFILE" size="small" class="btn-primary" @click="router.push({ path: `/admin/profile/instructors/${instructor.id}` })"></Button>
          </div>
        </div>
      </div>
      <div class="col-12">
        <Paginator 
          ...
          <template #start="slotProps">
            Showing data 1 to {{ slotProps.state.rows }} of  256K entries
          </template>
        </Paginator>
      </div>
    </div>
  ...
  <Dialog v-model:visible="visible" modal :style="{ width: '50vw' }" :breakpoints="{ '960px': '75vw', '641px': '90vw' }">
    ...
    <div class="flex flex-column gap-2 pb-3">
      ...
      <div class="flex flex-column md:flex-row gap-2">
        ...
        <Dropdown optionLabel="name" v-model="form.branch" placeholder="Branch" :options="branchList" class="p-inputtext-sm" />
