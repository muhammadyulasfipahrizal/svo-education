    ...
    <section style="margin-top: 10px; gap:10px">
                                    ...
                                    class="flex sm:col-6 justify-content-between gap-2 align-items-start flex-column p-0 sm:align-items-start sm:flex-row">
                                        <div class="dropdown-container">
                                            <div class="flex flex-row justify-content-between" @click="showDropdown()" style="cursor: pointer;">
                                                <p class="dropdown-text" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ selectedCategories.join(', ') }}</p>
                                            ...
                                            <div v-if="show">
                                                <div class="flex flex-row align-items-center" style="gap: 10px" v-for="category of categories" :key="category.key">
                                                    ...
                                                    <p class="dropdown-text">{{ category.name }}</p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="flex flex-column">
            ...
            <template v-if="steps.instructor">
                <div class="card p-1 flex flex-column my-3">
                    <h1 class="text-900 text-xl font-bold">Instructor</h1>
                    <div v-for="category in selectedCategories" :key="category">
                        <template v-if="category === 'David Burn'">
                            <div class="flex flex-column" style="gap: 10px">
                                <img src="/assets/img/avatar/avatar-2.jpeg" alt="David Burn" class="instructor-image" />
                                <p class="instructor-name black-2 font-size: 20px;">David Burn</p>
                                <div class="instructor-description">
                                    <p contenteditable class="black-2">As a developer instructor, I am passionate 
                        ...
                        <template v-else-if="category === 'Ava Baker'">
                            <div class="flex flex-column" style="gap: 10px">
                                <img src="/assets/img/dummy-instructor/ava-barker.jpeg" alt="Ava Baker" class="instructor-image" />
                                <p class="instructor-name black-2 font-size: 20px;">Ava Baker</p>
                                <div class="instructor-description">
                                    <p contenteditable class="black-2">As a developer instructor, I am passionate 
                                        about sharing my knowledge and experience with others who are eager to learn. 
                                        With a deep understanding of various programming languages and technologies, 
                        ...
                        <template v-else-if="category === 'Gabriel Hayes'">
                            <div class="flex flex-column" style="gap: 10px">
                                <img src="/assets/img/dummy-instructor/gabriel-hayes.jpeg" alt="Ava Baker" class="instructor-image" />
                                <p class="instructor-name black-2 font-size: 20px;">Gabrile Hayes</p>
                                <div class="instructor-description">
                                    <p contenteditable class="black-2">As a developer instructor, I am passionate 
                                        about sharing my knowledge and experience with others who are eager to learn. 
                                        With a deep understanding of various programming languages and technologies, 
