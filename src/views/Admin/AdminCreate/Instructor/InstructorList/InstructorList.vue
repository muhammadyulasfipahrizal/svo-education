        ...
        <Card class="my-5 shadow-5 col-12">
            <template #content>
                <div class="grid col-12 align-items-center justify-content-center">
                    <h1 class="title text-2xl sm:text-3xl col-7 md:col-8 lg:col-10">Assign Instructor</h1>
                    <Button label="NEW" @click="$router.push('/admin/create/instructor/add')" class="btn-new col-5 md:col-4 lg:col-2"></Button>
                </div>
            </template>
        </Card>
