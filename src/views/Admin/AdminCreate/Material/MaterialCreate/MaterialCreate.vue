...
<template>
    <section class="my-3">
                    ...
                    <li class="inter-normal black-2 text-lg" v-for="(item, itemIndex) in material.items" :key="itemIndex"
                        ...
                        <div class="flex flex-column md:flex-row md:align-items-center mx-2 gap-2 md:gap-0">
                            <Dropdown optionLabel="name" v-model="item.selectedType"
                                ...
                                class="mr-3 w-min md:w-14rem flex align-items-center" style="height: 35px">
                            ...
                            <div
                                class="flex justify-content-between py-0 m-0 gap-2 w-full align-items-center">
        ...
        <Button size="small" label="Add new material sources"
            class="w-full text text-white mt-4 btn-add-material border-noround" @click="addNewMaterial">
            <template #default>
