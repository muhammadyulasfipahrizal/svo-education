        ...
        <div class="grid w-full mt-3 wrapper gap-2">
            <div v-for="(mainTask, mainTaskIndex) in tasks" :key="mainTaskIndex" class="col-12 grid gap-2">
                ...
                <div class="p-2 border-round-lg surface-border border-1 w-full">
                    <div v-for="(task, taskIndex) in mainTask.subtasks" class="p-2 w-full">
                        <div
                            ...
                            <div class="flex gap-1">
                                <Button link size="small" class="p-0 m-0" v-if="taskIndex === mainTask.subtasks.length - 1"
                                    @click="addSubtask(mainTaskIndex)">
                        ...
                        <hr class="mt-3" v-if="taskIndex !== mainTask.subtasks.length - 1"
                            style="background: #D9D5EC; height: 1px;">
                    </div>
                </div>
