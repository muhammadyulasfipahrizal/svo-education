...
<template>
    <section>
        <section
            ...
            <h1 class="inter-normal black-1" style="font-size: 35px; font-weight: 700; padding: 10px 10px 0px 20px" >Student Grades</h1>
            <div class="col-12 grid" style="padding-right: 0px">
                ...
                <div
                    class="col-12 flex flex-row align-items-center justify-content-between filter-search dropdown-padding">
                    <div
                        class="col-12 md:col-10 lg:col-10 lg:col-10 grid grid-nogutter align-items-center filter-container mb-0 pb-0" style="gap: 10px;">
    ...
    <Dialog :dismissable-mask="true" v-model:visible="modalProfile" modal :style="{ width: '40vw' }" :breakpoints="{ '764px': '90vw' }">
        ...
        <div class="flex flex-column" style="padding: 10px; gap: 25px">
            ...
            <div class="line pt-0" style="margin-top: -10px"></div>
            <div class="flex flex-row align-items-center pt-0" style="padding-bottom: 5px; margin-top: -5px">
                <div class="flex flex-row align-items-center" style="gap: 10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <rect width="24" height="24" rx="12" fill="#659872" />
                        <path
