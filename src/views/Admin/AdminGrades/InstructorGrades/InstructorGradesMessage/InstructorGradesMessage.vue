    ...
    <section class=" bg-white">
        <section
            ...
            <div class="flex align-items-center col-12 p-0 m-0">
                <Button size="small" link @click="$router.push('/admin/grade/instructor')">
                    <template #icon>
                        <div>
            ...
            <div class="flex flex-column col-12" style="gap: 10px">
                ...
                <div class="flex justify-content-center w-full">
                    <img :src="selectedProfile?.image" alt="" style="width: 200px; height: 200px;"/>
                </div>
                <div class="flex flex-column w-full" style="gap: 10px">
                    <h1 class="inter-normal black-1" style="font-size: 25px; font-weight: 700;">
                        Message
                    </h1>
                    <Textarea class="message p-inputtext-sm" :placeholder="message ? message : ''" autoResize rows="5"
                     style="background-color: white !important"></Textarea>
